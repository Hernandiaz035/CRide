    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('used', models.BooleanField(default=False, help_text='Only unused invitations can join users.')),
                ('used_at', models.DateTimeField(blank=True, help_text='Date time on which the invitation was used', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now=True, help_text='Date time on which the object was created', verbose_name='created_at')),
                ('modified', models.DateTimeField(auto_now_add=True, help_text='Date time on which the object was last modified', verbose_name='modified_at')),
                ('is_admin', models.BooleanField(default=False, help_text="Cirlce admins can update the circle's data and manage its members.", verbose_name='circle admin')),
