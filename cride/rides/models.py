...
class Ride(CRideModel):
    ...
    Contains the ride information."""

    offered_by = models.ForeignKey('users.User', null=True, on_delete=models.SET_NULL)
    offered_in = models.ForeignKey('circles.Circle', null=True, on_delete=models.SET_NULL)
